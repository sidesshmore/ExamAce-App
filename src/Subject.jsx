...
const SUBJECTS = [
  'CSC601- Data Analytics and Visualization', 'CSC602- Cryptography and System Security', 'CSC603- Software Engineering and Project Management', 'CSC604- Machine Learning'
];
...
const BOOKS = {
  'CSC602- Cryptography and System Security': [
    { 
      ...
      cover: 'https://m.media-amazon.com/images/I/51mzEbU-nBL._UF1000,1000_QL80_.jpg',
    },
    { 
      id: 2, 
      title: 'Notes on Cryptography',      
      cover: 'https://d1csarkz8obe9u.cloudfront.net/posterpreviews/notes-template-design-9d18fb23558d6331c1f545bcb17fd6c3_screen.jpg?ts=1645871443',
    }
  ],
  'CSC601- Data Analytics and Visualization': [
    { 
      id: 3, 
      title: ' Data Science and Big Data Analytics: Discovering, Analyzing, Visualizing and Presenting Data,EMC Education services Wiley Publication',  
  ...
  'CSC603- Software Engineering and Project Management': [
    { 
      id: 5, 
      title: "Roger S. Pressman, Software Engineering: A practitioner's approach",  
      cover: 'https://m.media-amazon.com/images/I/816xr5ywK9L._AC_UF1000,1000_QL80_.jpg',
    },
    { 
      id: 6, 
      title: 'Notes on Cryptography',       
...
const BookBrowsingApp = () => {
  const [selectedSubject, setSelectedSubject] = useState('CSC601- Data Analytics and Visualization');
  ...
  const handleBookClick = (book) => {
    ...
    navigate(`/chat/${book.id}`, { state: { book } });
  };
  ...
  return (
    <div className="container mx-auto p-6">
      ...
      {/* Subject Dropdown */}
      <div className="mb-6">
        <label htmlFor="subject-select" className="block mb-2 text-sm font-medium">
          Select a Subject
        </label>
        <select 
          id="subject-select"
